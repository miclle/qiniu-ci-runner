...
- 刷新时的当前分支：`feat/admin-sandbox-lists`。
- 评审目标：file-based config、GORM-backed DB schema migration、retry/lease/audit handling、ordinary-user Sandbox catalogs、admin console、embedded UI assets 和 local development workflow 更新后的实现状态。
