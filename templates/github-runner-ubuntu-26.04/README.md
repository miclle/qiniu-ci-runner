...
This preview 8-vCPU, 8192-MiB Linux x86_64 template requests a 20-GiB disk
when created. It uses the pinned Canonical-published Ubuntu 26.04 OCI index in
